...
class mycurl {
    ...
    public function createCurl($url = 'nul') {
        ...
        //A linha abaixo deve ser comentada no momento da autenticação e descomentada no momento das consultas a aplicação
        //curl_setopt($s, CURLOPT_HTTPHEADER, array('Expect:', 'Accept: application/vnd.github.squirrel-girl-preview'));
        //A linha abaixo deve ser descomentada para a coleta do search
        //curl_setopt($s, CURLOPT_HTTPHEADER, array('Expect:', 'Accept: application/vnd.github.cloak-preview'));
